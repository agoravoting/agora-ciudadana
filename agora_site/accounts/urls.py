...
urlpatterns = patterns('',
    ...
    url(r'^register/complete/invite/(?P<activation_key>\w+)/$',
       accounts_views.RegisterCompleteInviteView.as_view(),
       name='register-complete-invite'),
    url(r'^register/complete/fnmt/(?P<activation_key>\w+)/$',
       accounts_views.RegisterCompleteFNMTView.as_view(),
       name='register-complete-fnmt'),
    #url(r'^register/complete/idcat/(?P<activation_key>\w+)/$',
    #   accounts_views.RegisterCompleteidCATView.as_view(),
    #   name='register-complete-idcat'),
