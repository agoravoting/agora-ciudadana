...
class Approval(BaseVotingSystem):
    ...
    def get_question_field(election, question):
        ...
        return ApprovalField(label=question['question'],
...
class ApprovalField(JSONFormField):
    '''
    ...
    def __init__(self, choices, election, question, *args, **kwargs):
        ...
        return super(ApprovalField, self).__init__(*args, **kwargs)
    ...
    def clean(self, value):
        ...
        if self.election.is_secure():
            ...
            if len(value) > 0:
                clean_value = super(ApprovalField, self).clean(value)
                return {
                    "a": "plaintext-answer",
                    "choices": clean_value,
                }
