...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.security_policy'
        db.add_column('agora_core_election', 'security_policy',
                      self.gf('django.db.models.fields.CharField')(default='PUBLIC_VOTING', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.security_policy'
        db.delete_column('agora_core_election', 'security_policy')
