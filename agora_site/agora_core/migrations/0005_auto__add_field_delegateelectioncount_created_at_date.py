...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DelegateElectionCount.created_at_date'
        db.add_column('agora_core_delegateelectioncount', 'created_at_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 17, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DelegateElectionCount.created_at_date'
        db.delete_column('agora_core_delegateelectioncount', 'created_at_date')
