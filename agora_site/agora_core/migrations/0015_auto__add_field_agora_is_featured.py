...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agora.featured_election'
        db.add_column('agora_core_agora', 'featured_election',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agora.featured_election'
        db.delete_column('agora_core_agora', 'featured_election')
    ...
    models = {
        ...
        'agora_core.delegateelectioncount': {
            ...
            'created_at_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
