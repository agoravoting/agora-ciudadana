...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.short_description'
        db.alter_column('agora_core_profile', 'short_description', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))

        # Changing field 'Profile.lang_code'
        db.alter_column('agora_core_profile', 'lang_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Profile.biography'
        db.alter_column('agora_core_profile', 'biography', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Profile.short_description'
        db.alter_column('agora_core_profile', 'short_description', self.gf('django.db.models.fields.CharField')(default='', max_length=140))

        # Changing field 'Profile.lang_code'
        db.alter_column('agora_core_profile', 'lang_code', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Profile.biography'
        db.alter_column('agora_core_profile', 'biography', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        'agora_core.agora': {
            ...
            'featured_election': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'agora_core.delegateelectioncount': {
            ...
            'created_at_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 24, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'agora_core.election': {
            ...
            'release_tally_automatically': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'agora_core.profile': {
            ...
            'biography': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'email_updates': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'extra': ('agora_site.misc.utils.JSONField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang_code': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'null': 'True', 'blank': 'True'}),
