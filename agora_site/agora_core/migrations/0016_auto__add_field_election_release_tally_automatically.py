...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.release_tally_automatically'
        db.add_column('agora_core_election', 'release_tally_automatically',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.release_tally_automatically'
        db.delete_column('agora_core_election', 'release_tally_automatically')
    ...
    models = {
        ...
        'agora_core.delegateelectioncount': {
            ...
            'created_at_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 21, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
