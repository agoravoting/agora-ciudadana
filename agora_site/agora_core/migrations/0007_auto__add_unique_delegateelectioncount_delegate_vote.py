...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DelegateElectionCount', fields ['delegate_vote']
        db.create_unique('agora_core_delegateelectioncount', ['delegate_vote_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DelegateElectionCount', fields ['delegate_vote']
        db.delete_unique('agora_core_delegateelectioncount', ['delegate_vote_id'])
    ...
    models = {
        ...
        'agora_core.delegateelectioncount': {
            ...
            'delegate_vote': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'delegate_election_count'", 'unique': 'True', 'null': 'True', 'to': "orm['agora_core.CastVote']"}),
