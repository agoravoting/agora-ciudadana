...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('agora_core_agora', (
            ...
            ('delegation_election', self.gf('django.db.models.fields.related.ForeignKey')(related_name='delegation_agora', null=True, to=orm['agora_core.Election'])),
            ...
            ('pretty_name', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('short_description', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ...
        # Adding unique constraint on 'Agora', fields ['name', 'creator']
        db.create_unique('agora_core_agora', ['name', 'creator_id'])
        ...
        db.create_table('agora_core_election', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hash', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True)),
            ('tiny_hash', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True, null=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('agora', self.gf('django.db.models.fields.related.ForeignKey')(related_name='elections', null=True, to=orm['agora_core.Agora'])),
            ...
            ('created_at_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('is_vote_secret', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('result', self.gf('agora_site.misc.utils.JSONField')(null=True)),
            ('delegated_votes_result', self.gf('agora_site.misc.utils.JSONField')(null=True)),
            ('pretty_name', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('short_description', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('questions', self.gf('agora_site.misc.utils.JSONField')(null=True)),
            ('election_type', self.gf('django.db.models.fields.CharField')(default='ONCE_CHOICE', max_length=50)),
            ('eligibility', self.gf('agora_site.misc.utils.JSONField')(null=True)),
            ('extra_data', self.gf('agora_site.misc.utils.JSONField')(null=True)),
        ))
        ...
        # Adding M2M table for field delegated_votes on 'Election'
        db.create_table('agora_core_election_delegated_votes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('election', models.ForeignKey(orm['agora_core.election'], null=False)),
            ('castvote', models.ForeignKey(orm['agora_core.castvote'], null=False))
        ))
        db.create_unique('agora_core_election_delegated_votes', ['election_id', 'castvote_id'])
        ...
        db.create_table('agora_core_castvote', (
            ...
            ('is_counted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('action_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True)),
            ('data', self.gf('agora_site.misc.utils.JSONField')()),
            ('invalidated_at_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('casted_at_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Agora', fields ['name', 'creator']
        db.delete_unique('agora_core_agora', ['name', 'creator_id'])
        ...
        # Removing M2M table for field delegated_votes on 'Election'
        db.delete_table('agora_core_election_delegated_votes')
