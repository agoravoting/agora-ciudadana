...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        '''
        Set all existing tallied elections to tally released
        '''
        for election in orm.Election.objects.all():
            if election.result_tallied_at_date is not None:
                election.tally_released_at_date = election.result_tallied_at_date
                election.save()
