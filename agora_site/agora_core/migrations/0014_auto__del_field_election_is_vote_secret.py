...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Election.is_vote_secret'
        db.delete_column('agora_core_election', 'is_vote_secret')

        # Adding field 'Election.pubkey_created_at_date'
        db.add_column('agora_core_election', 'pubkey_created_at_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Election.tally_released_at_date'
        db.add_column('agora_core_election', 'tally_released_at_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Election.orchestra_status'
        db.add_column('agora_core_election', 'orchestra_status',
                      self.gf('agora_site.misc.utils.JSONField')(null=True),
                      keep_default=False)

        # Adding field 'Election.pubkeys'
        db.add_column('agora_core_election', 'pubkeys',
                      self.gf('agora_site.misc.utils.JSONField')(null=True),
                      keep_default=False)

        # Adding M2M table for field authorities on 'Election'
        db.create_table('agora_core_election_authorities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('election', models.ForeignKey(orm['agora_core.election'], null=False)),
            ('authority', models.ForeignKey(orm['agora_core.authority'], null=False))
        ))
        db.create_unique('agora_core_election_authorities', ['election_id', 'authority_id'])


    def backwards(self, orm):
        # Adding field 'Election.is_vote_secret'
        db.add_column('agora_core_election', 'is_vote_secret',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Election.pubkey_created_at_date'
        db.delete_column('agora_core_election', 'pubkey_created_at_date')

        # Deleting field 'Election.tally_released_at_date'
        db.delete_column('agora_core_election', 'tally_released_at_date')

        # Deleting field 'Election.orchestra_status'
        db.delete_column('agora_core_election', 'orchestra_status')

        # Deleting field 'Election.pubkeys'
        db.delete_column('agora_core_election', 'pubkeys')

        # Removing M2M table for field authorities on 'Election'
        db.delete_table('agora_core_election_authorities')
    ...
    models = {
        ...
        'agora_core.delegateelectioncount': {
            ...
            'created_at_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'agora_core.election': {
            ...
            'archived_at_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
            'authorities': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'elections'", 'symmetrical': 'False', 'to': "orm['agora_core.Authority']"}),
            'comments_policy': ('django.db.models.fields.CharField', [], {'default': "'ANYONE_CAN_COMMENT'", 'max_length': '50'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '70'}),
            'orchestra_status': ('agora_site.misc.utils.JSONField', [], {'null': 'True'}),
            ...
            'pretty_name': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'pubkey_created_at_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
            'pubkeys': ('agora_site.misc.utils.JSONField', [], {'null': 'True'}),
            ...
            'security_policy': ('django.db.models.fields.CharField', [], {'default': "'PUBLIC_VOTING'", 'max_length': '50'}),
            'short_description': ('django.db.models.fields.CharField', [], {'max_length': '140'}),
            'tally_released_at_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
            'tiny_hash': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True', 'null': 'True'}),
