...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agora.comments_policy'
        db.add_column('agora_core_agora', 'comments_policy',
                      self.gf('django.db.models.fields.CharField')(default='ANYONE_CAN_COMMENT', max_length=50),
                      keep_default=False)

        # Adding field 'Election.comments_policy'
        db.add_column('agora_core_election', 'comments_policy',
                      self.gf('django.db.models.fields.CharField')(default='ANYONE_CAN_COMMENT', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agora.comments_policy'
        db.delete_column('agora_core_agora', 'comments_policy')

        # Deleting field 'Election.comments_policy'
        db.delete_column('agora_core_election', 'comments_policy')
