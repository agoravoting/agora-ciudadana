...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DelegateElectionCount.count_percentage'
        db.add_column('agora_core_delegateelectioncount', 'count_percentage',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'DelegateElectionCount.rank'
        db.add_column('agora_core_delegateelectioncount', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DelegateElectionCount.delegate_vote'
        db.add_column('agora_core_delegateelectioncount', 'delegate_vote',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='delegate_election_count', null=True, to=orm['agora_core.CastVote']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DelegateElectionCount.count_percentage'
        db.delete_column('agora_core_delegateelectioncount', 'count_percentage')

        # Deleting field 'DelegateElectionCount.rank'
        db.delete_column('agora_core_delegateelectioncount', 'rank')

        # Deleting field 'DelegateElectionCount.delegate_vote'
        db.delete_column('agora_core_delegateelectioncount', 'delegate_vote_id')
    ...
    models = {
        ...
        'agora_core.delegateelectioncount': {
            ...
            'created_at_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 17, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
