...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DelegateElectionCount'
        db.create_table('agora_core_delegateelectioncount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('delegate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='delegate_election_counts', to=orm['auth.User'])),
            ('election', self.gf('django.db.models.fields.related.ForeignKey')(related_name='delegate_election_counts', to=orm['agora_core.Election'])),
            ('count', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('agora_core', ['DelegateElectionCount'])

        # Adding unique constraint on 'DelegateElectionCount', fields ['election', 'delegate']
        db.create_unique('agora_core_delegateelectioncount', ['election_id', 'delegate_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DelegateElectionCount', fields ['election', 'delegate']
        db.delete_unique('agora_core_delegateelectioncount', ['election_id', 'delegate_id'])

        # Deleting model 'DelegateElectionCount'
        db.delete_table('agora_core_delegateelectioncount')
